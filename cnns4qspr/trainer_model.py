...
from cnns4qspr.gradient_flow import plot_grad_flow
from torch.utils.data import IterableDataset
from torch.utils.data.sampler import SubsetRandomSampler
from bisect import bisect
import os, psutil # used to monitor memory usage
import fnmatch
from cnns4qspr.model import create_model
...
class CNNTrainer():
    def __init__(self,
        ...
        self.network = create_model(self.model_config, self.input_size)
        print(self.network)
        ...
        self.max_grad = self.args.max_grad
        ...
        for epoch in range(epochs):
            ...
            for batch_idx, data_t in enumerate(train_loader):
                ...
                if batch_idx % 100 == 0 and self.grad_figs:
                    plot_grad_flow(epoch, batch_idx, self.network.named_parameters(), self.max_grad)
                self.optimizer.step()
                self.optimizer.zero_grad()
